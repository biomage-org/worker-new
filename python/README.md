...
For **local development**, make sure you have [InfraMock](https://github.com/parsebio/inframock)
running alongside the [ui](https://github.com/parsebio/ui) and [api](https://github.com/parsebio/api)
...
You can find this [here](https://github.com/parsebio/api/blob/master/src/specs/api.yaml).
